 ...
 * the site. Elements tagged `svc-*` animate on card hover (see globals.css);
 * the whole diagram lifts + scales, with a signature micro-motion per type.
 */
...
function Frame({ children }: { children: React.ReactNode }) {
  return (
    <svg
      viewBox="0 0 96 64"
      fill="none"
      className="svc-illus h-20 w-auto"
      aria-hidden
      strokeLinecap="round"
...
function Carousel() {
  return (
    <Frame>
      <rect className="svc-accent svc-fan-l" x="8" y="18" width="18" height="30" rx="3" stroke="currentColor" strokeWidth="2" opacity="0.3" />
      <rect className="svc-accent svc-fan-r" x="70" y="18" width="18" height="30" rx="3" stroke="currentColor" strokeWidth="2" opacity="0.3" />
...
function Static() {
  return (
    <Frame>
      ...
      <circle className="svc-accent svc-pop" cx="40" cy="22" r="7" stroke={GOLD} strokeWidth="1.8" fill={GOLD} fillOpacity="0.18" />
...
function Stories() {
  return (
    <Frame>
      ...
      <path className="svc-accent svc-pop" d="M40.5 40.5l2 2 3.5-3.5" stroke={GOLD} strokeWidth="1.8" />
...
function Giveaway() {
  return (
    <Frame>
      ...
      <rect className="svc-accent svc-rise" x="26" y="21" width="38" height="8" rx="2" stroke="currentColor" strokeWidth="2.2" />
      <path d="M45 21v31" stroke={GOLD} strokeWidth="2.2" />
      <path className="svc-accent svc-rise" d="M45 21c-6-8-13-2-9 1M45 21c6-8 13-2 9 1" stroke={GOLD} strokeWidth="2.2" />
      <path d="M64 15h12l4 5-4 5H64z" stroke={GOLD} strokeWidth="1.8" fill={GOLD} fillOpacity="0.15" />
      <circle cx="68" cy="20" r="1.4" fill={GOLD} />
      <path className="svc-accent svc-spin" d="M20 16l1.3 3.4 3.4 1.3-3.4 1.3L20 25.4l-1.3-3.4L15.3 20.7l3.4-1.3z" fill={GOLD} />
    </Frame>
  );
}

/* Banner Ads — a sponsored "AD" slide sitting mid-way through a swipe carousel. */
function Banners() {
  return (
    <Frame>
      {/* neighbouring content slides */}
      <rect className="svc-accent svc-fan-l" x="8" y="18" width="18" height="30" rx="3" stroke="currentColor" strokeWidth="2" opacity="0.3" />
      <rect className="svc-accent svc-fan-r" x="70" y="18" width="18" height="30" rx="3" stroke="currentColor" strokeWidth="2" opacity="0.3" />
      {/* the sponsored AD slide */}
      <rect x="32" y="11" width="32" height="40" rx="4" stroke={GOLD} strokeWidth="2.4" fill={GOLD} fillOpacity="0.12" />
      <rect className="svc-accent svc-pop" x="36" y="15" width="15" height="9" rx="2" fill={GOLD} />
      <text x="43.5" y="22" textAnchor="middle" fontSize="6.5" fontWeight="800" fill="#0b0b0c" fontFamily="inherit">AD</text>
      <line x1="37" y1="33" x2="59" y2="33" stroke="currentColor" strokeWidth="2.2" />
      <line x1="37" y1="39" x2="53" y2="39" stroke="currentColor" strokeWidth="2" opacity="0.5" />
      <line x1="37" y1="45" x2="56" y2="45" stroke="currentColor" strokeWidth="2" opacity="0.5" />
      {/* swipe chevrons */}
      <path d="M25 29l-4 4 4 4" stroke="currentColor" strokeWidth="2" opacity="0.5" />
      <path d="M71 29l4 4-4 4" stroke="currentColor" strokeWidth="2" opacity="0.5" />
      {/* pager dots — AD is the active slide in the middle of the post */}
      <circle cx="44" cy="57" r="1.5" fill="currentColor" opacity="0.3" />
      <circle cx="49" cy="57" r="1.7" fill={GOLD} />
      <circle cx="54" cy="57" r="1.5" fill="currentColor" opacity="0.3" />
    </Frame>
  );
}
...
function Generic() {
  return (
    <Frame>
      ...
      <circle className="svc-accent svc-pop" cx="38" cy="20" r="3" fill={GOLD} />
